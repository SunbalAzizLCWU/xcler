...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: getCanonicalPath(locale, "/services/ai-chatbots-agents"),
      languages: getLanguageAlternates("/services/ai-chatbots-agents"),
    },
  };
}
...
export default async function AIChatbotsPage({
  ...
  return (
    <>
      <JsonLd id={`service-ai-chatbots-agents-${locale}`} data={schema} />
      {faqSchema ? <JsonLd id={`service-ai-chatbots-agents-faq-${locale}`} data={faqSchema} /> : null}
