...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: getCanonicalPath(locale, "/services/wordpress-entwicklung"),
      languages: getLanguageAlternates("/services/wordpress-entwicklung"),
    },
  };
}
      ...
      <section className="section-padding pt-32">
        <div className="container-custom">
          <AnimatedSection>
            ...
            <p className="mt-6 text-lg text-richblack/50 dark:text-cream/50 max-w-2xl">{t("intro")}</p>
          </AnimatedSection>
