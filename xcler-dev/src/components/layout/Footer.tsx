...
export async function Footer({ locale }: { locale: string }) {
  ...
  const footerLinks: {
    ...
    services: [
      ...
      { label: t("links.services.wordpressGermany"), href: "/services/wordpress-development-germany" },
      { label: t("links.services.shopifyGermany"), href: "/services/shopify-development-germany" },
    ],
    company: [
