        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <AnimatedSection>
            <div className="lg:sticky lg:top-32">
              ...
              <p className="mt-4 text-richblack/50 dark:text-cream/50">
            ...
            {faqs.map((faq, i) => (
              <AnimatedSection key={i} delay={i * 0.1}>
                <div className="border-b border-stone/10 dark:border-stone-dark/10">
                  ...
                  >
                    <span className="font-heading text-lg font-medium pr-4 group-hover:text-terracotta transition-colors">
                      {faq.question}
                    </span>
                    <motion.svg
                      animate={{ rotate: openIndex === i ? 180 : 0 }}
                      transition={{ duration: 0.3 }}
                      className="mt-1 h-5 w-5 shrink-0 text-stone"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={2}
                  ...
                  <AnimatePresence>
                    {openIndex === i && (
                      ...
                      >
                        <p className="pb-6 text-richblack/60 dark:text-cream/60 leading-relaxed">
                          {faq.answer}
                        </p>
                      </motion.div>
                    )}
