        ...
        <div className="mt-16">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <blockquote className="font-heading text-2xl md:text-3xl lg:text-4xl font-medium leading-snug tracking-tight text-richblack dark:text-cream">
                {testimonials[active].quote}
              </blockquote>
              <div className="mt-8 flex items-center gap-4 text-richblack dark:text-cream">
                <div className="h-12 w-12 rounded-full bg-stone/20 dark:bg-stone-dark/20 flex items-center justify-center">
                  <span className="font-heading font-semibold text-sm text-richblack dark:text-cream">
                    {testimonials[active].name[0]}
                  </span>
                </div>
                <div>
                  <p className="font-heading font-semibold text-richblack dark:text-cream">
                    {testimonials[active].name}
                  </p>
                  <p className="text-sm text-richblack/60 dark:text-cream/70">
